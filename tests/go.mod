...
require (
	...
	github.com/moseszane168/gaussdb v0.0.0-20250520091323-38bb0151cd25
...
require (
	...
	github.com/HuaweiCloudDeveloper/gaussdb-go v0.0.0-20250424093817-6546ce07372a // indirect
